...
/**
 * Clase que crea la ventana de dificultad
 */
public class dificultad extends JFrame{
	
	//Variables globales de los botones de dificultad
	...
	public dificultad(String usuario, String contra) {
		...
		facil.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//Try Catch para obtener los valores de los ajustes segun su dificultad
				try {
				...
				//Miramos si existe una partida del usuario
		...
		normal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				i = 0;
				//Infectamos las ciudades aleatoriamente
				while(j != infectadas) {
					if((int)(Math.random()*20) == 2) {
		...
		personalizado.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//Try Catch para reescribir el fichero personalizado.xml con los valores que introduce el usuario
				try {
					FileReader fr = new FileReader(NomFit);
					BufferedReader br = new BufferedReader(fr);
	...
	/**
     * Llena el array de 48 ciudades con la informacion correspondiente
     *
     * @return Ciudad[]  Devuelve el array de ciudades lleno
     */
	public static Ciudad[] llenarCiudades() {
		...
		//Try Catch para leer el fichero ciudades.txt
		try {
			...
			while(texto != null) {
				...
				texto = br.readLine();
				//Ponemos el val que funciona como indice a 0
				val[0] = 0;
				if(texto != null) {
					...
					//Con el numero de comas podemos saber cuantas ciudades colindantes tiene la ciudad
					comas = 0;
					...
					//Llenamos las ciudades colindantes
		...
		/**
	    * Llena el array de 4 virus con la informacion correspondiente
	    *
	    * @return Virus[]  Devuelve el array de virus lleno
	    */
		...
		/**
		* Llena el array de 4 vacunas con la informacion correspondiente
		*
		* @return Vacunas[]  Devuelve el array de vacunas lleno
		*/
		...
		*
		* @param total  String donde se encuentra toda la informacion de una ciudad
		* @param val  Indice que se usa para mirar la linea del fichero actual
		* @return nombreCiudad  Nombre de la ciudad
		*/
		...
		/**
		* Devuelve las coordenandas de la ciudad
		*
		* @param total  String donde se encuentra toda la informacion de una ciudad
		* @param val  Indice que se usa para mirar la linea del fichero actual
		* @return coord  Coordenadas de la ciudad
		*/
		...
		/**
	    * Devuelve en string la línea con el valor introducido por el usuario
	    *
	    * @param usuario  Valor que ha introducido anteriormente el usuario
	    * @param linea  Contenido total de la linea del fichero XML
	    * @param linea1 Contenido modificado de la linea del fichero XML que se quiere guardar
	    * @param entrada Variable de tipo Scanner
		* @return linea1  Contenido que se quiere guardar del fichero XML
		*/
		...
		/**
		* Devuelve en string todo el fichero modificado con los valores del usuario
	    *
	    * @param entrada Variable de tipo Scanner
	    * @param lineaTot String donde se almacena todo el documento XML modificado
	    * @param usuario  Valor que ha introducido anteriormente el usuario
	    * @param linea  Contenido total de la linea del fichero XML
	    * @param linea1 Contenido modificado de la linea del fichero XML que se quiere guardar
	    * @param fr  Nombre del objeto FileReader para leer el fichero
	    * @param br  Nombre del objeto BufferedReader para leer el fichero
		* @return lineaTot  String donde se almacena todo el documento XML modificado
		*/
		...
		/**
	    * Devuelve el valor que hay en los ficheros XML
	    *
	    * @param fr  Nombre del objeto FileReader para leer el fichero
	    * @param br  Nombre del objeto BufferedReader para leer el fichero
	    * @param linea String que contiene la linea a leer del fichero XML
	    * @return linea1  Contenido que se quiere guardar del fichero XML
	    */

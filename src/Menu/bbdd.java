 ...
 */
public class bbdd {
	private static final String USER = "DW1_2324_ROD_ALEJANDRO";
	private static final String PWD = "A41631497W";
     ...
     * ADVERTENCIA, SOLO PODEIS BUSCAR RESULTADOS DE UNA SOLA FILA, SI SE ENCUENTRA MAS DE UNA FILA
     ...
     * EN ESTE CASO SI PODEIS IMPRIMIR MAS DE UNA FILA.
     *
     * @param con                         Objeto Connection que representa la conexión a la base de datos.
     * @param sql                         Sentencia SQL de consulta.

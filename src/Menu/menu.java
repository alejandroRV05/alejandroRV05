...
/**
 * Clase que crea la ventana de menu
 */
public class menu extends JFrame{
    ...
    public menu(String usuario, String contra) {
        ...
        //Creacion del boton de Nueva Partida
        ...
        //Label para la version del juego
        ...
        //Creacion del boton de Instrucciones
        ...
        //Creacion del boton de Cargar Partida
        ...
        CargarPartida.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				...
				//Hacemos un Select para mirar si hay una partida guardada
    			if(Select[0].charAt(0) != '0') {
    				
    				//Creamos las ciudades, virus y vacunas
    				...
    				//Hacemos Selects para obtener los valores de la Base de Datos
    				listaElementosSeleccionados = new String[1];
    				...
    				//Bucle para llenar la infección de las ciudades
    				for(int i = 0; i < 48; i++) {
    					listaElementosSeleccionados = new String[1];
    				...
    				//Selects para obtener los calores de desarrollo de las vacunas
    				listaElementosSeleccionados = new String[1];
    				...
    				//Select para obtener el modo de dificultad
    				listaElementosSeleccionados = new String[1];
					...
					//Pasamos los parametros al constructor para crear el nuevo tablero
    ...
    /**
     * Inicia la musica del menu
     *
     * @param filePath  Ruta del archivo WAV de la musica
     */
    ...
    /**
     * Para mostrar la ventana con las instrucciones del juego
     *
     */
    ...
    /**
     * Para mostrar la ventana con el ranking
     *
     */
    private void mostrarRanking() {
		...
		//Hacemos Selects para obtener las mejores puntuaciones de cada dificultad
